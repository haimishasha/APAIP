...
public class AlleviationSituationDao {
	 ...
	 * 扶贫情况的
	 */
	public static List<Applicant> listapplicant_info() throws SQLException{
		
		
		
		List<Applicant> list = new ArrayList<Applicant>();
		Connection con =DBUtil.getConnection();
		String sql = "select applicantID,applicantName,applicantSex,applicantNation,applicantAddress,education,applicantPhone from applicant_info";
		...
		while(rs.next()){
			...
			String applicantSex=rs.getString("applicantSex");
			applicant.setApplicantSex(applicantSex);
			
			String applicantNation=rs.getString("applicantNation");
			...
			String applicantPhone=rs.getString("applicantPhone");

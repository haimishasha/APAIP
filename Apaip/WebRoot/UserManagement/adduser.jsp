    ...
    <div class="admin-content-body">
      ...
      <div class="am-g">
        ...
        <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
          <form class="am-form am-form-horizontal" action="http://localhost:8080/Apaip/servlet" method="POST">

            <div class="am-form-group">
              <label for="user-name" class="am-u-sm-3 am-form-label">用户名</label>
              <div class="am-u-sm-9">
                <input type="text" name="userName" placeholder="输入你的用户名/userName">
                <small>分配的用户名最好是名字的拼音，不允许有重名产生。</small>
              </div>
            </div>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <label class="am-radio-inline">
                  <input type="radio" name="userSex" value="男" required> 男
                </label>
                <label class="am-radio-inline">
            ...
            <div class="am-form-group">
              <div class="am-u-sm-9 am-u-sm-push-3">
                <button type="submit" class="am-btn am-btn-primary" name="cmd" value="add">保存</button>
              </div>
            </div>
          </form>
        </div>
